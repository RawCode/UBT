...
public class AutoSave implements Runnable, Listener
{
	...
	/*
	String S1 = new String("��������".getBytes("CP866"),"CP866"); //valid for logfile
	String S2 = new String("��������".getBytes(),"CP866"); //not valid completely
	String S3 = new String("��������".getBytes("CP866")); //valid for console
	String S4 = new String("��������"); //valid for logfile*/
	
	//String S1 = new String("��������".getBytes("CP1252"));
	//String S2 = new String("��������".getBytes("CP1251")); //this is logfile encoding
	//String S3 = new String("��������".getBytes("CP866")); //this is console encoding
	//String S4 = new String("��������".getBytes("UTF-8"));
