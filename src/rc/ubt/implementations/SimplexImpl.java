...
public class SimplexImpl
{
	...
	final double x;
	final double y;
	SimplexImpl(double x, double y)
	{
		this.x = x;
		this.y = y;
	}

	static SimplexImpl grad3[] = {
		new SimplexImpl(1,1),new SimplexImpl(-1,1),new SimplexImpl(1,-1),new SimplexImpl(-1,-1),
		new SimplexImpl(1,0),new SimplexImpl(-1,0),new SimplexImpl(1, 0),new SimplexImpl(-1, 0),
		new SimplexImpl(0,1),new SimplexImpl(0,-1),new SimplexImpl(0, 1),new SimplexImpl(0,-1)};
